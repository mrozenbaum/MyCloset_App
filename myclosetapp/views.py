...
from .models import Profile, Category, Item, User




from myclosetapp.models import User, Profile, Category, Item
...
def index(request):
    return HttpResponse("Hello, world. You're at the MyCloset App homepage!!!")
...
def my_categories(request):
    template_name = 'my_categories.html'
    if request.method == 'GET':
        return render(register, template_name) 
